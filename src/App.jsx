...
const DAYS = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "11:00 AM", title: "National Express → Victoria Coach Stn", detail: "~45 min ride. Luggage included if pre-booked.", type: "travel", icon: "🚌", tag: "BOOKED ✓" },
  ...
  },
  {
    ...
    events: [
      { time: "9:00 AM", title: "★ Westminster Abbey", detail: "9 AM slot. Allow 1.5–2 hrs. Audio guide included.", type: "activity", icon: "⛪", tag: "BOOKED ✓" },
      ...
      { time: "1:30 PM", title: "★ Churchill War Rooms", detail: "1:30 PM slot. Allow 1.5–2 hrs. Kids enjoy the interactive table.", type: "activity", icon: "🏛️", tag: "BOOKED ✓" },
      ...
      { time: "7:30 PM", title: "★ Hadestown — West End", detail: "All 4 seats booked! Pre-show dinner nearby in Soho / Covent Garden.", type: "activity", icon: "🎭", tag: "BOOKED ✓" },
    ]
  },
  {
  ...
  },
  {
    ...
    events: [
      ...
      { time: "4:30 PM", title: "★ Arc de Triomphe — rooftop terrace", detail: "284 steps to 360° views of Paris. Included in Museum Pass.", type: "activity", icon: "🏛️", tag: "BOOK AHEAD" },
      { time: "6:00 PM", title: "Walk Champs-Élysées → Trocadéro", detail: "Best Eiffel Tower photo spot. Golden hour lighting.", type: "activity", icon: "🗼", tag: "FREE" },
      { time: "10:00 PM", title: "Dinner in the 7th / Rue Cler", detail: "Great restaurants near Eiffel Tower. Or walk back to Latin Quarter.", type: "food", icon: "🍽️" },
      { time: "11:00 PM", title: "★ Eiffel Tower — evening ascent", detail: "Sunset/night views from the summit! Tickets booked.", type: "activity", icon: "🗼", tag: "BOOKED ✓" },
    ]
  },
  {
    ...
    events: [
      ...
      { time: "11:30 AM", title: "Last Paris lunch", detail: "Savor it — boulangerie, bistro, or crêperie!", type: "food", icon: "🥐" },
      { time: "1:00 PM", title: "Return to Airbnb — grab luggage", detail: "Checkout 18:00 but you leave by 14:30. Arrange early pickup or Nannybag near Gare du Nord.", type: "tip", icon: "🧳" },
      { time: "2:30 PM", title: "Métro to Gare du Nord (Line 4)", detail: "From Saint-Michel, ~15 min. Arrive 90 min before departure for security + border.", type: "travel", icon: "🚇" },
      ...
      { time: "5:35 PM", title: "Arrive St. Pancras", detail: "Walk across the street to The Megaro Hotel — 1 minute!", type: "travel", icon: "🛬" },
      { time: "6:00 PM", title: "Check into The Megaro Hotel", detail: "1 Belgrove St, WC1H 8AB. 2× Standard Double, £603.50 total.", type: "lodging", icon: "🏨" },
      { time: "7:00 PM", title: "Farewell dinner in London", detail: "Hotel restaurant (Italian) or explore King's Cross / Granary Square.", type: "food", icon: "🌙" },
    ]
  },
  {
    ...
    events: [
      ...
      { time: "11:00 AM", title: "Check out — Tube to Paddington", detail: "Northern Line or Circle/Hammersmith to Paddington (~15 min).", type: "travel", icon: "🚇" },
      { time: "11:30 AM", title: "Heathrow Express → LHR", detail: "Runs every 15 min, ~15 min ride. £25/person advance vs £32 walk-up.", type: "travel", icon: "🚄", tag: "BUY AHEAD" },
...
const TODO_ITEMS = [
  ...
  { priority: "NOW", text: "Confirm The Megaro Hotel booked (Jul 16)", detail: "2× Standard Double, £603.50. Verify reservation. themegaro.co.uk", link: "https://www.themegaro.co.uk", status: "todo" },
  ...
  { priority: "BEFORE", text: "Verify credit cards — no foreign transaction fees", detail: "Check all cards. Consider no-FTF card (e.g. Capital One). Venmo cards verified — no FTF.", status: "todo" },
  ...
  { priority: "DONE", text: "UK ETA — all 4 travelers", detail: "All 4 ETAs approved. £16 each.", status: "done" },
  { priority: "DONE", text: "Eiffel Tower tickets", detail: "Evening ascent booked for Jul 15 (~11 PM summit).", status: "done" },
  { priority: "DONE", text: "West End show — Hadestown booked", detail: "4 seats confirmed for Jul 10, 7:30 PM.", status: "done" },
  { priority: "DONE", text: "Churchill War Rooms tickets", detail: "Booked for Jul 10, 1:30 PM slot.", status: "done" },
  { priority: "DONE", text: "Westminster Abbey tickets", detail: "Booked for Jul 10, 9:00 AM slot.", status: "done" },
  { priority: "DONE", text: "National Express bus (LHR→Victoria)", detail: "Jul 9, ~11:00 from LHR T2. Booked with luggage.", status: "done" },
  { priority: "DONE", text: "Louvre timed entry", detail: "Booked for Jul 15, 9:00 AM slot.", status: "done" },
